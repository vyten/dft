...
function new_form() {
	echo <<<EOF
	<form class="w3-container w3-wide w3-xlarge" action="xx" method="post">
		<h3><b>Distans</b></h3>
		<input type="text" name="inputDistance" class="w3-border w3-round-large w3-gray" size="3"></input>&nbsp;knop
